    ...
    if (type === 'postit') {
        ...
        if (res.ok) {
            ...
            if (type === 'group') {
                ...
                // Pour les Displays : on recharge les données ET on force le rafraîchissement des listes de réglages
                await loadGroupData(currentGid);
                await refreshParamsLists(); // <-- C'est cette ligne qui manquait !
            }
        }
    }
}
